...
const Navigation = () => {
  return (
    <nav className="text-primary-50 m-auto flex max-w-[90rem] items-center justify-between px-24 text-lg/8 font-light">
      ...
      <div className="flex items-center gap-x-3">
        <button className="border-primary-50 transition-properties hover:bg-primary-50 hover:text-primary-1300 font box-border cursor-pointer rounded-full border-2 px-8 py-3.5 font-normal">
          Login
        </button>
